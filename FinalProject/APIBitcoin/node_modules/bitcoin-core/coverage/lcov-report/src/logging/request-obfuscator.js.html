...
<head>
    <title>Code coverage report for src/logging/request-obfuscator.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../index.html">All files</a> / <a href="index.html">src/logging</a> request-obfuscator.js</h1>
        <div class='clearfix'>
...
&nbsp;
  <span class="missing-if-branch" title="if path not taken" >I</span>if (!request.body) {
...
&nbsp;
  <span class="missing-if-branch" title="if path not taken" >I</span>if (!instance.body) {
<span class="cstat-no" title="statement not covered" >    return;</span>
  }
&nbsp;
  <span class="missing-if-branch" title="if path not taken" >I</span>if (!isJSON(request.body)) {
<span class="cstat-no" title="statement not covered" >    return;</span>
  }
&nbsp;
