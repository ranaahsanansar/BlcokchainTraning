...
<head>
    <title>Code coverage report for src/methods.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../index.html">All files</a> / <a href="index.html">src</a> methods.js</h1>
        <div class='clearfix'>
...
<a name='L861'></a><a href='#L861'>861</a></td><td class="line-coverage quiet"><span class="cline-any cline-neutral">&nbsp;</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">/* eslint-disable no-inline-comments */
&nbsp;
/**
 * Module dependencies.
 */
...
module.exports = {
  ...
  importMulti: {
    ...
    obfuscate: {
      request: {
        ...
        named: <span class="fstat-no" title="function not covered" >pa</span>rams =&gt; <span class="cstat-no" title="statement not covered" >_.set(params, 'requests', _.map(params.requests, <span class="fstat-no" title="function not covered" >re</span>quest =&gt; <span class="cstat-no" title="statement not covered" >_.set(request, 'keys', _.map(request.keys, <span class="fstat-no" title="function not covered" >()</span> =&gt; <span class="cstat-no" title="statement not covered" >'******')</span>))</span>)</span>
      }
    },
    version: '&gt;=0.14.0'
  },
  ...
  setHdSeed: {
    ...
    obfuscate: {
      request: {
        default: <span class="fstat-no" title="function not covered" >pa</span>rams =&gt; <span class="cstat-no" title="statement not covered" >_.set([...params], '[1]', '******'),</span>
        named: <span class="fstat-no" title="function not covered" >pa</span>rams =&gt; <span class="cstat-no" title="statement not covered" >_.set(params, 'seed', '******')</span>
      }
    },
    version: '&gt;=0.17.0'
  },
  ...
  signRawTransaction: {
    ...
    obfuscate: {
      request: {
        ...
        named: params =&gt; _.set(params, 'privkeys', _.map(params.privkeys || <span class="branch-1 cbranch-no" title="branch not covered" >[],</span> () =&gt; '******'))
      }
    },
