...
<head>
    <title>Code coverage report for src/requester.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../index.html">All files</a> / <a href="index.html">src</a> requester.js</h1>
        <div class='clearfix'>
...
module.exports = class Requester {
  constructor({ methods = <span class="branch-0 cbranch-no" title="branch not covered" >{},</span> version } = <span class="branch-0 cbranch-no" title="branch not covered" >{})</span> {
