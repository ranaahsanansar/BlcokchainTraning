// import {abi} from '../contracts/Traning.sol/Traning.json';
...
import TxHashModel from "../models/TxHashModel.js";
class ERC720Controller {
  static mintNFT = async (to, url) => {
    try {
      let contractAddress = process.env.CONTRACT_ADDRESS
      // const { etherem } = window;
      // const provider = await ethers.JsonRpcProvider(process.env.MUMBAI_URL);
      ...
      console.log("Error in Minting to Blockchain");
      console.log(err);
...
// 0x006D625740bcE48FCa4cd637A8360411BbA29465